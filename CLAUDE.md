...
`marcos-ai-bootstrap` is unusual: this repo **is** the package *and* it dogfoods the package on itself. Two layers coexist, and conflating them is an easy, real mistake — keep them strictly separate.
